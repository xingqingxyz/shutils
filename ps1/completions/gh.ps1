Register-ArgumentCompleter -Native -CommandName crush, dlv, dms, docker, gh, glow, golangci-lint, golangci-lint-v2, goreleaser, qodercli, tstoy, vhs, yq -ScriptBlock {
