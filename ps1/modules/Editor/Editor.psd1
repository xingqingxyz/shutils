#
# Module manifest for module 'Editor'
#
...
@{
    ...
    GUID                 = 'c37bb6f1-e300-4bbd-b436-658b2cda0f0c'
    ...
    RequiredModules      = @('PowerShellEditorServices.Commands')
    ...
    FunctionsToExport    = @('e.i', 'e.info', 'e.warn', 'e.err', 'e.msg', 'e.sur')
