...
@{
  ...
  FunctionsToExport    = @('batf', 'icat', 'Get-TypeMember', 'Set-SystemProxy', 'Set-Region', 'Test-Administrator', 'Invoke-CodeFormatter', 'Import-EnvironmentVariable', 'Set-EnvironmentVariable')
  ...
  AliasesToExport      = @('gtm', 'icf', 'setenv')
