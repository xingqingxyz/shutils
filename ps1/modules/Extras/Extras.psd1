...
@{
  ...
  FunctionsToExport    = @('yq', 'tq', 'packageJSON', 'sortJSON', 'setenv', 'icat', 'batf', 'Test-Administrator', 'Set-Region', 'Enable-EnvironmentFile', 'Update-Environment', 'Invoke-CodeFormatter')
