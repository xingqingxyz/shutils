Configuration MtSetupConfig {
  ...
  $packages = @('PSDesiredStateConfiguration', 'PSDscResources', 'ComputerManagementDsc', 'Microsoft.WinGet.Client', 'Microsoft.WinGet.DSC', 'Microsoft.Windows.Developer', 'Microsoft.PowerToys.Configure', 'Refresh-EnvironmentVariables', 'powershell-yaml')
...
'@ | ConvertFrom-Json -AsHashtable
  ...
  $winget = @('7zip.7zip', 'AutoHotkey.AutoHotkey', 'Git.Git', 'MiKTeX.MiKTeX', 'RustDesk.RustDesk', 'LocalSend.LocalSend', 'JohnMacFarlane.Pandoc', 'Nutstore.Nutstore', 'voidtools.Everything', 'Nvidia.GeForceExperience', 'Microsoft.PowerShell', 'Microsoft.Edge', 'Microsoft.EdgeWebView2Runtime', 'Tencent.WeChat', 'Tencent.QQ', 'Intel.IntelDriverAndSupportAssistant', 'Python.Launcher', 'Baidu.BaiduNetdisk', 'BurntSushi.ripgrep.MSVC', 'Kingsoft.WPSOffice.CN', 'Miller.Miller', 'aria2.aria2', 'bootandy.dust', 'junegunn.fzf', 'sharkdp.bat', 'sharkdp.fd', 'Python.Python.3.12', 'Microsoft.PowerToys', 'Microsoft.VisualStudioCode', 'ImageMagick.Q16-HDRI', 'Microsoft.WindowsTerminal')
